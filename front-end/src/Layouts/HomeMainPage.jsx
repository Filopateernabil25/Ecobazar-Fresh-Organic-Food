...
import './assets/HomeMainPage.css' // Create this CSS file for styling
import { Link, NavLink, Outlet } from 'react-router-dom';
import { useCart } from '../Pages/product/CartContext.jsx';
...
export default function HomeMainPage() {
    ...
    return (
        <>
            ...
            <section className="top-header" style={{  background: "#333333"}}>
